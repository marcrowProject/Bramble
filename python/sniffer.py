...
th_sniffer= Sniffer(address[3],"dns","./result/scanNetwork/dns_http_sniffed.txt")
...
print(colors.CLEAR)
dns_get_parser("./result/scanNetwork/dns_http_sniffed.txt","./result/scanNetwork/dns_http_sniffed_proper.txt")
